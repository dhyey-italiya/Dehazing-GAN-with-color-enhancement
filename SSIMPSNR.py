...
import scipy.misc
import numpy as np
from np_utils import _validate_lengths
...
def crop(ar, crop_width, copy=False, order="K"):
    ...
    # print(slices)
    if copy:
        cropped = np.array(ar[slices[0]], order=order, copy=True)
    else:
        cropped = ar[slices[0]]
    return cropped
...
def compute_psnr(ref_dir, res_dir, ref_im, res_im):
...
def compute_mssim(ref_dir, res_dir, ref_im, res_im):
...
# ref_dir = "/Users/abirabh/Documents/DL Project Task 2/final_dataset/val/testB"
# res_dir = "/Users/abirabh/Documents/DL Project Task 2/final_dataset/val/dehazed_output"
